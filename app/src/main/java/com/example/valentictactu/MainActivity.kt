...
// Rangkuman pada file main activity ini berisi berisi beberapa perintah diantaranya pembuatan variable pemain pertama dan pemain kedua, kondisi seri apabila keduanya tidak menang
// dan tidak kalah, kondisi apabila pemain x menang, kondisi apabila pemain o menang , menampilkan hasil skor permainan, lalu pada activity ini terdapat tombol howtoplay
// yang dimana nantinya apabila user menekn tuombol tersebut akan berpindah ke activity selanjutnya, button ini menggunakan perintah intent untuk menuju menu selanjutnya